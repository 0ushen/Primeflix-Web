...
import {
  ApplicationName,
  ApplicationPaths,
} from '../constants/authorize.constants';
...
export class AuthorizeService {
  ...
  public async signIn(state: any): Promise<IAuthenticationResult> {
    ...
    let user: User = null;
    try {
      let args = this.createArguments();
      user = await this.userManager.signinSilent(args);
  ...
  private createArguments(state?: any): any {
    return { useReplaceToNavigate: false, data: state };
  }
